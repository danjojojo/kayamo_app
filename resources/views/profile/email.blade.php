                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="d-sm-flex justify-content-between align-items-center mb-4">
                            <h2 class="fw-bolder text-dark mb-0">Change Email Address</h2>
                        </div>
                            ...
                            <div class="col-auto col-md-8 col-lg-6 col-xl-5 col-xxl-4" style="width: 871.094px;">
                                <div class="card mb-5">
                                    <div class="card-body p-sm-5">
                                        <form action="{{ route('profile_edit_email', $user)}}" method="post" style="margin-top: 0px;" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')  
                                            <div class="mb-5">
                                                ...
                                                <input class="form-control" type="text" name="email" value="{{ $user->email }}" style="@error('email') border-color: rgb(205,68,59); @enderror">
                                                @error('email')
