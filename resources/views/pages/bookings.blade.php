                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="d-sm-flex justify-content-between align-items-center mb-4">
                            <h2 class="fw-bolder text-dark mb-0">Bookings</h2>
                        </div>
                        ...
                        @if (Auth::user()->acctype == 'customer')
                            ...
                            <div class="text-white bg-primary border rounded border-primary d-flex flex-column justify-content-between flex-lg-row p-4 p-md-5 mb-4" >
                                <div class="pb-2 pb-lg-1">
                                    <h3 class="fw-bold mb-2">Your bookings will appear here.</h3>
                                    <p class="mb-0">Track your booking progress here.</p>
                                </div>
                            </div>
                        @else
                            <div class="text-white bg-primary border rounded border-primary d-flex flex-column justify-content-between flex-lg-row p-4 p-md-5 mb-4" >
                                <div class="pb-2 pb-lg-1">
                                    <h3 class="fw-bold mb-2">Your bookings will appear here.</h3>
                                    <p class="mb-0">No bookings? Send a quote.</p>
                                    <p class="mb-0">Showcasing your done works in Portfolio can be helpful.</p>
                                </div>
                            </div>
                        @endif
                        <div class="row gy-4 row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1" style="margin-bottom: 24px;">
                            ...
                            @if (count($bookings) > 0)
                                            ...
                                            <div class="card">
                                                <div class="card-body p-4">
                                                    ...
                                                    <a href="{{ route('bookings.show', $booking->id) }}" wire:navigate>
                                                        <button class="btn btn-primary float-end" type="button" style="background: rgb(78, 115, 223);">View Progress</button>
                                                    </a>
                                ...
                                @endforeach
                            @else
                                <x-blank msg="There are no active bookings at the moment."/> 
                            @endif
                        </div>
                        <div>
                            {{ $bookings->links() }}
