                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="d-sm-flex justify-content-between align-items-center mb-4">
                            <h2 class="fw-bolder text-dark mb-0">Quote Details</h2>
                        </div>
                            ...
                            <div class="col-auto col-md-8 col-lg-6 col-xl-5 col-xxl-4" style="width: 871.094px;">
                                <div class="card mb-5">
                                    <div class="card-body p-sm-5">
                                        <form action="{{ route('quotes.store') }}" method="post" style="margin-top: 0px;">
                                            @csrf
                                            <input type="hidden" name="service_request_id" value="{{ $request }}">
                                            <div class="mb-3">
                                                <label class="form-label"><strong>Initial quote</strong></label>
                                                <input name="amount" class="form-control" type="number" placeholder="The starting price of your service for this job." style="@error('amount') border-color: rgb(205,68,59); @enderror">
                                                @error('amount')
